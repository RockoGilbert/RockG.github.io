...
const Projects = () => {
  return (
    <div name="Projects" className="w-80% h-screen bg-[#0a192f] text-gray-200">
      <div className="flex flex-col sm:flex justify-center items-center w-70% h-full">
        ...
        <div className="w-3Learni grid grid-cols-3 gap-10 text-center ml-10 py-10">
          <div className="w-3/4 shadow-md shadow-[#040c16] hover:Scale-110 duration-500">
            ...
            <img className="object-cover w-3/4 h-60 mx-auto mt-7" src={smiling_cover} alt="smiling-cover" />
          ...
          <div className="shadow-md shadow-[#040c16] hover:Scale-110 duration-500">
            ...
            <img className="object-cover w-3/4 h-60 mx-auto mt-7" src={Kahuna} alt="Kahuna" />
            <p className="my-8">
          ...
          <div className="shadow-md shadow-[#040c16] hover:Scale-110 duration-500">
            ...
            <img className="object-cover w-full h-60 mx-auto mt-7" src={AirBnB} alt="AirBnb" />
            <p className="my-8">
